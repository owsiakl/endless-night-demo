...
export class ScaleKeyframe implements Keyframe
{
    public constructor(
    ...
    public update(bone: Object3D, currentTime: number)
    {
        ...
        bone.setScale(this.interpolator.scale(this.data[currentIndex], this.data[currentIndex + 1], interpolationValue));
    }
